...
export default function WorkshopPageClient({ translations: t }: WorkshopPageClientProps) {
    ...
    const workshopDate = new Date('2025-12-23T20:00:00');
    const now = new Date();
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900">
            ...
            {/* Header */}
            <div className="relative border-b border-slate-800 bg-slate-950/50 backdrop-blur-sm">
                <div className="mx-auto max-w-6xl px-4 py-4">
                    <Link href="/" className="inline-flex items-center gap-2 text-slate-300 transition-colors hover:text-emerald-400">
                ...
                <div className="grid gap-8 lg:grid-cols-2">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-pink-500/10 p-6 transform transition-transform hover:scale-[1.02]">
                            <p className="mb-4 text-sm font-semibold uppercase tracking-wide text-purple-300 flex items-center gap-2">
                                <Clock className="h-4 w-4 animate-pulse" />
                                {t.countdownLabel}
                            </p>
                            <div className="flex gap-4">
                                <div className="text-center transform transition-transform hover:scale-110">
                                    <div className="text-4xl font-bold text-white bg-gradient-to-br from-purple-400 to-pink-400 bg-clip-text text-transparent">
                                        {daysLeft}
                                    </div>
                                    <div className="text-sm text-slate-400">{t.daysUnit}</div>
                                </div>
                                <div className="text-center transform transition-transform hover:scale-110">
                                    <div className="text-4xl font-bold text-white bg-gradient-to-br from-purple-400 to-pink-400 bg-clip-text text-transparent">
                                        {hoursLeft}
                                    </div>
                                    <div className="text-sm text-slate-400">{t.hoursUnit}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <div
                                    key={idx}
                                    className="flex items-center gap-3 rounded-xl border border-slate-700 bg-slate-800/50 p-4 transition-all hover:border-emerald-500/50 hover:bg-slate-800 hover:scale-105"
                                >
                        ...
                        <div className="space-y-6 rounded-2xl border border-slate-700 bg-slate-800/50 p-6 backdrop-blur-sm">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2">
                                    {t.detailsTopics.map((topic, idx) => (
                                        <li
                                            key={idx}
                                            className="flex items-start gap-2 text-slate-300 transform transition-all hover:translate-x-2"
                    ...
                    <div className="lg:sticky lg:top-8 lg:h-fit">
                        <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-slate-800/80 to-slate-900/80 p-8 shadow-2xl backdrop-blur-sm transform transition-all hover:scale-[1.02]">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full rounded-lg border border-slate-600 bg-slate-900/50 px-4 py-3 text-white placeholder-slate-500 transition-all focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:scale-[1.02]"
                                        />
                                    </div>
