...
const formatBytesToKb = (bytes: number) =>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white/80 p-3">
                      <button
                        ...
                        className="flex w-full items-center justify-between text-sm font-semibold text-emerald-700"
                      >
                        <span>{tCreate('advancedSettingsToggle')}</span>
                        <span className="text-xs font-normal text-gray-600">
                          {showAdvancedOptions
                            ? tCreate('advancedSettingsCollapse')
                            : tCreate('advancedSettingsExpand')}
                        </span>
                      </button>
                      {showAdvancedOptions && (
                        <div className="space-y-3 pt-3">
                          <p className="text-xs text-gray-600">
                            {tCreate('advancedAssetsHint', {
                              size: customAssetMaxKb,
                          ...
                          <div className="flex flex-wrap items-center gap-3">
                            ...
                            <span className="text-xs text-gray-500">
                              {tCreate('advancedAssetsCount', {
                                used: customAssets.length,
                                limit: MAX_CUSTOM_ASSET_COUNT,
                              })}
                            </span>
                          </div>
                          {customAssetError && (
                            <p className="text-xs text-red-600">{customAssetError}</p>
                          )}
